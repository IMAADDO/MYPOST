...
<head>
    ...
    <title><?php echo e(config('app.name', 'Laravel Blog')); ?> - Welcome</title>
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(Request::is('/') ? 'active' : ''); ?>" href="<?php echo e(route('welcome')); ?>">Home</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="hero-section">
        ...
        <div>
            <h1 class="hero-title">Welcome to Laravel Blog</h1>
            <p class="hero-subtitle">Discover amazing stories and create your own!</p>
        </div>
    </div>
    ...
    <div class="container welcome-content">
        ...
        <?php endif; ?>
        <p class="welcome-text">Join our community to share your thoughts, explore diverse topics, and connect with others. Whether you're here to read or write, there's something for everyone!</p>
        <div class="cta-buttons">
            <?php if(auth()->guard()->guest()): ?>
                <a href="<?php echo e(route('register')); ?>" class="btn btn-cta">Get Started</a>
                <a href="<?php echo e(route('login')); ?>" class="btn btn-cta">Login</a>
            <?php endif; ?>
            <?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(route('posts.create')); ?>" class="btn btn-cta">Create Your Post</a>
                <a href="<?php echo e(route('dashboard')); ?>" class="btn btn-cta">Go to Dashboard</a>
            <?php endif; ?>
        </div>
                ...
                <div class="post-item">
                    ...
                    <div class="post-content-container">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <a href="<?php echo e(route('posts.show', $post)); ?>" class="btn btn-custom btn-sm">Read More</a>
                            <?php if(auth()->guard()->check()): ?>
...
</html><?php /**PATH C:\Users\dell\mypost\resources\views/welcome.blade.php ENDPATH**/ ?>