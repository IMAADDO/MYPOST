...
<head>
    ...
    <title><?php echo e(config('app.name', 'Laravel Blog')); ?> - Edit Post</title>
        ...
        <div class="edit-card">
            ...
            <form action="<?php echo e(route('posts.update', $post)); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="content" id="content" class="form-control" rows="4" required><?php echo e(old('content', $post->content)); ?></textarea>
                </div>
                <div class="mb-3">
                    <label for="body" class="form-label">Body</label>
                    <textarea name="body" id="body" class="form-control" rows="6" required><?php echo e(old('body', $post->body)); ?></textarea>
                </div>
                <div class="mb-3">
                    <label for="image" class="form-label">Post Image (optional)</label>
                    <input type="file" name="image" id="image" class="form-control">
                    <?php if($post->image): ?>
                        <p class="mt-2">Current Image: <img src="<?php echo e(asset('storage/' . $post->image)); ?>" alt="Post Image" style="max-width: 200px; margin-top: 10px;"></p>
                    <?php endif; ?>
                </div>
                <button type="submit" class="btn-update">Update Post</button>
                <a href="<?php echo e(route('posts.show', $post)); ?>" class="btn btn-secondary ms-2">Cancel</a>
            </form>
        </div>
    </div>
...
</html><?php /**PATH C:\Users\dell\mypost\resources\views/posts/edit.blade.php ENDPATH**/ ?>