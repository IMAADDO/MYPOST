...
<head>
    ...
    <title><?php echo e(config('app.name', 'Laravel Blog')); ?> - Dashboard</title>
...
<body>
    ...
    <div class="hero-section">
        ...
        <h1 class="hero-title">Your Dashboard</h1>
    </div>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="stats-card">
                    <h4>Total Posts</h4>
                    <p class="text-center"><?php echo e(\App\Models\Post::where('user_id', auth()->id())->count()); ?></p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="stats-card">
                    ...
                    <p class="text-center">
                        ...
                        ?>
                        <?php echo e($lastPost ? $lastPost->title : 'No posts yet'); ?>
            ...
            <div class="col-md-4">
                <div class="stats-card">
                    <h4>Joined On</h4>
                    <p class="text-center"><?php echo e(auth()->user()->created_at->format('d M Y')); ?></p>
                </div>
            </div>
        </div>
                    ...
                    <div class="post-item">
                        ...
                        <div class="post-content-container">
                            <div>
                                ...
                                <p class="post-meta">Posted on <?php echo e($post->created_at->format('d M Y')); ?></p>
                            </div>
                            <div class="d-flex justify-content-between align-items-center">
                                <a href="<?php echo e(route('posts.show', $post)); ?>" class="btn btn-custom btn-sm">View</a>
                                <?php if(auth()->guard()->check()): ?>
                                    <div>
...
</html><?php /**PATH C:\Users\dell\mypost\resources\views/home.blade.php ENDPATH**/ ?>